...
JEI_DIR = game_root_dir + "\.minecraft\\versions\ROR-1.19.3\mods\REI"
REI_DIR = game_root_dir + "\.minecraft\\versions\ROR-1.19.3\mods\JEI"


# 为REI文件夹中没有“.disabled”后缀的文件添加“.disabled”后缀
...
# 为JEI文件夹中有“.disabled”后缀的文件取消“.disabled”后缀
